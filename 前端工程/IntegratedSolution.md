...
2. **后端为主的MVC时代**  
    ...
    <img src="./images/IntegratedSolution/01.png" width="500" />
...
3. **Ajax带来的SPA时代**  
    ...
    <img src="./images/IntegratedSolution/02.png" width="500" />  
...
4. **前端为主的MVC、MV\*时代**  
    ...
    <img src="./images/IntegratedSolution/03.png" width="500" />  

5. **Node带来的全栈时代**  
    随着NodeJS的兴起，为前端带来了一种新的开发模式。业界比较出名的实践是，阿里巴巴的中途岛计划（Midway，基于eggJS的二开）。  

    <img src="./images/IntegratedSolution/04.png" width="400" />  
...
2. 采用组件化的编程思想，处理UI层
    ...
    <img src="./images/IntegratedSolution/05.png" width="500" />  
